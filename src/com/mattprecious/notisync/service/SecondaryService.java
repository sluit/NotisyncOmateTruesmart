...
public class SecondaryService extends Service {
	...
	private void handleTextMessage(TextMessage message) {
		...
		notificationsDbAdapter.insertNotification("text.message", 
				"smsmms", "SMS/MMS", sender, PhoneNumberUtils.formatNumber(message.number), System.currentTimeMillis() + "");
	...
	private void handlePhoneCallMessage(PhoneCallMessage message) {
		...
		openNotificationDatabaseWrite();
		notificationsDbAdapter.insertNotification("phone.call", 
				"phone", "Phone call", text, PhoneNumberUtils.formatNumber(message.number), System.currentTimeMillis() + "");
		notificationsDbAdapter.close();
	}
	...
	private void handleGtalkMessage(GtalkMessage message) {
		...
		openNotificationDatabaseWrite();
		notificationsDbAdapter.insertNotification("com.google.android.talk", 
				"talk", "Hangouts", message.sender, message.message, System.currentTimeMillis() + "");
		notificationsDbAdapter.close();
	}
